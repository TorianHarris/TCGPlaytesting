...
public class CardManager : MonoBehaviour
{
    ...
    public void FillCardInfo(string cardName, string cost, int power, int health, Card.cardType type, string typeName, Color color, string mainEffect, string secondaryEffect, Sprite art, string trait, Card reference)
    {
        ...
        if (costText)
            costText.text = cost.Replace("O", "<sprite name=\"Orange\">").Replace("R", "<sprite name=\"Red\">").Replace("G", "<sprite name=\"Green\">").Replace("Y", "<sprite name=\"Yellow\">").Replace("N1", "<sprite name=\"N1\">").Replace("N2", "<sprite name=\"N2\">").Replace("N3", "<sprite name=\"N3\">").Replace("N4", "<sprite name=\"N4\">").Replace("N5", "<sprite name=\"N5\">").Replace("N6", "<sprite name=\"N6\">");
        if (cardType)
        ...
        if (mainEffectText)
            mainEffectText.text = mainEffect.Replace("[", "<b>[").Replace("]", "]</b>").Replace("n/", "\n").Replace("<<", "<b><i>").Replace(">>", "</i></b>").Replace("#O", "<sprite name=\"Orange\">").Replace("#R", "<sprite name=\"Red\">").Replace("#G", "<sprite name=\"Green\">").Replace("#Y", "<sprite name=\"Yellow\">").Replace("N1", "<sprite name=\"N1\">").Replace("N2", "<sprite name=\"N2\">").Replace("N3", "<sprite name=\"N3\">").Replace("N4", "<sprite name=\"N4\">").Replace("N5", "<sprite name=\"N5\">").Replace("N6", "<sprite name=\"N6\">");
